    ...
    <DefaultLayout>
      <section className="justify-center pb-4 md:pb-6">
        <div className="text-center mb-6">
          ...
          <p className="mt-5">
            As a non-profit service organization, our main priority is serving
            the community. Your support allows for continued outreach and
            assistance to communities and goes towards executing large-scale
            service projects such as overnighter, Youth Service Day, RPI Service
            Day, helps us attend conferences like nationals, and helps offset
            costs not covered by brother dues. Each dollar you donate goes
            towards our service program and maintaining our office.
          </p>
          <p className="mt-5">
