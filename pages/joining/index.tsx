    ...
    <section className="justify-center pb-4 md:pb-6">
      ...
      <div className="grid md:grid-cols-2 gap-6 mt-8 mb-8">
        <div>
          ...
          <p className="mt-4">
            As a potential brother, we want to make sure you are comfortable! If
            any personal issues or problems arise during the process, do not
            hesitate to reach out and contact newmembereducators@apoez.org or
            president@apoez.org, or any brother you feel comfortable with.
            ...
            make you do personal favors, and they are not allowed to drink with
            New Members even if both parties are 21 or older. Should any
        ...
        <div>
          ...
          <p>
            ...
            and execute service events, complete service hours, learn how to run
            our office, learn how to retrieve and find lost and found from
            ...
            on-campus brotherhood party. The brotherhood party will occur during
            the last week of the New Member process, signifying the end of the
            New Member process. At the end of the New Member Process, there is a
            brotherhood wide vote on the New Members and initiations for the New
            Brothers.
          </p>
        </div>
      </div>
